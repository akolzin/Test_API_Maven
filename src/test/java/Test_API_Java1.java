...
public class Test_API_Java1 {
    ...
    public void requestUs(String payload1, String payload2, String payload3) {
        ...
        given().
                pathParam("payload1", payload1).pathParam("payload2", payload2).
                pathParam("payload3", payload3).
                contentType(ContentType.JSON).
                log().all().
                when().
                post("http://api.openweathermap.org/data/2.5/weather?{payload1}{payload2}&{payload3}").
                then().
                log().all().
                assertThat().
                statusCode(200).
                contentType("application/json").
                body("name", startsWith(payload2));
